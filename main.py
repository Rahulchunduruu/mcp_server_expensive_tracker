...
def build_prompt(problem: str):
    return f"""
        ...
        6. If i didn't mentioned mode of payment_method then assume it is credit card else it debit card or cash.
...
@mcp.tool()
def add_expense(date, amount, category, subcategory, payment_method, note=""):
